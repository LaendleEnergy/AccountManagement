...
insert into household_user (date_of_birth, email_address, gender, household_id, household_member_id, member_name, user_password, user_role) values ('1995-09-28', 'felix.lahnsteiner@students.fhv.at', 'MALE', 'h2', '2', 'Felix Lahnsteiner', 'secret', 'USER');
insert into household_user (date_of_birth, email_address, gender, household_id, household_member_id, member_name, user_password, user_role) values ('1990-05-15', 'alice@example.com', 'FEMALE', 'h1', '1', 'Alice', '79XRn7pTF6sf33S8GGhkwL7gbs5bIAhuUULKmpdEA7U=', 'ADMIN');